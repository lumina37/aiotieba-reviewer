...
先在目标用户的个人主页复制包含其[`tieba_uid`](https://v-8.top/tutorial/start#tieba_uid)的字符串
...
**参数1**: `刚刚复制的那坨东西` (用户id: 包含[tieba_uid](https://v-8.top/tutorial/start#tieba_uid)的字符串)
...
点开用户主页，在链接里找到一串`tb.1.`开头的东西，这个东西叫[`portrait`](https://v-8.top/tutorial/start#portrait)<br>
每个用户都有唯一的[`portrait`](https://v-8.top/tutorial/start#portrait)<br>
把它复制出来
...
`id`: [`用户名`](https://v-8.top/tutorial/start#user_name)或[`portrait`](https://v-8.top/tutorial/start#portrait)或包含[`tieba_uid`](https://v-8.top/tutorial/start#tieba_uid)的字符串或包含[`user_id`](https://v-8.top/tutorial/start#user_id)的字符串，它们都可以用来唯一地确定一个贴吧用户

+ [`用户名`](https://v-8.top/tutorial/start#user_name): 请注意将其与可重复的`昵称`相区分。每个贴吧用户的用户名都是唯一的，但用户可以没有用户名<br>
+ [`portrait`](https://v-8.top/tutorial/start#portrait): 一般是以`tb.1.`开头的一串字符串<br>
用网页端处理用户时，推荐使用这个[`portrait`](https://v-8.top/tutorial/start#portrait)方法予以精准定位<br>
+ 包含[`tieba_uid`](https://v-8.top/tutorial/start#tieba_uid)的字符串: [`tieba_uid`](https://v-8.top/tutorial/start#tieba_uid)需要被两个`#`号包围，如`#12345678#`<br>
在较新版贴吧app的用户主页的用户头像下方有个长得像`ID:12345678`的东西，点它右侧的那个复制按钮复制出来的一串东西，就能作为这里的参数<br>
用app处理无用户名的用户，或者用户名很复杂的用户时，推荐使用这个包含[`tieba_uid`](https://v-8.top/tutorial/start#tieba_uid)的字符串方法予以精准定位<br>
+ 包含[`user_id`](https://v-8.top/tutorial/start#user_id)的字符串: 每个贴吧用户都有且仅有一个[`user_id`](https://v-8.top/tutorial/start#user_id)。[`user_id`](https://v-8.top/tutorial/start#user_id)需要被两个`/`号包围，如`/12345678/`<br>
一般仅用于吧务通过后台数据表中记录的[`user_id`](https://v-8.top/tutorial/start#user_id)反查用户信息，普通用户接触不到<br>
...
`id`: [`用户名`](https://v-8.top/tutorial/start#user_name)或[`portrait`](https://v-8.top/tutorial/start#portrait)或包含[`tieba_uid`](https://v-8.top/tutorial/start#tieba_uid)的字符串或包含[`user_id`](https://v-8.top/tutorial/start#user_id)的字符串
...
`id`: [`用户名`](https://v-8.top/tutorial/start#user_name)或[`portrait`](https://v-8.top/tutorial/start#portrait)或包含[`tieba_uid`](https://v-8.top/tutorial/start#tieba_uid)的字符串或包含[`user_id`](https://v-8.top/tutorial/start#user_id)的字符串<br>
